...
<div class="tag-card-cta">Open the guide →</div>
</a>

</div>

<div class="tag-quick" markdown>
<div class="tag-quick-title">Jump straight to the busiest pages</div>
<div class="tag-quick-links" markdown>
[Verifying documents](recruiter/06-verification.md){ .tag-chip }
[Worker profiles & tiers](recruiter/05-profiles-tiers.md){ .tag-chip }
[Messaging workers](recruiter/07-messaging.md){ .tag-chip }
[The audit trail](recruiter/10-audit-trail.md){ .tag-chip }
[Compliance reports](recruiter/09-compliance-reporting.md){ .tag-chip }
[Troubleshooting](recruiter/13-troubleshooting.md){ .tag-chip }
</div>
</div>

<div class="tag-foot" markdown>
Need a person? **[support@tagconstructionltd.co.uk](mailto:support@tagconstructionltd.co.uk)** · Need paper? Open **Print site** in the navigation for the full PDF · [Change log](changelog.md)
</div>
